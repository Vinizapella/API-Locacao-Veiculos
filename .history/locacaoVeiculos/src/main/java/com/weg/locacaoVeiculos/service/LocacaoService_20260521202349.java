...
public class LocacaoService {
    ...
    public LocacaoResponseDTO criarLocacao(
   ...
   public List<LocacaoResponseDTO> listarClientesPoId(Long clienteId){
        return locacaoRepositorio.buscarLocacaoPorClienteId(clienteId)
                .stream()
                .map(locacao -> new LocacaoResponseDTO(
                        locacao.getId(), 
                        locacao.getDias(),
